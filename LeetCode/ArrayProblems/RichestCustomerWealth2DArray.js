...
// 1. Create function that takes 2D Array

//2. calculate each arrray inside the parent array sum
...
// 3. compare sum of each array and return largest number
...
for (let y = 0; y < accounts[i].length; y++) {    
 c += accounts[i][y];   
}
d.push(c);
c=0;
